...
*/
     ...
     *  @{
     */
        #define LED_4_INTR_NONE      (uint16)(0x0000u)
        #define LED_4_INTR_RISING    (uint16)(0x0001u)
        #define LED_4_INTR_FALLING   (uint16)(0x0002u)
        #define LED_4_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define LED_4_INTR_MASK      (0x01u) 
#endif /* (LED_4__INTSTAT) */
...
/* SIO registers */
#if defined(LED_4__SIO_CFG)
    #define LED_4_SIO_HYST_EN        (* (reg8 *) LED_4__SIO_HYST_EN)
    #define LED_4_SIO_REG_HIFREQ     (* (reg8 *) LED_4__SIO_REG_HIFREQ)
    #define LED_4_SIO_CFG            (* (reg8 *) LED_4__SIO_CFG)
    #define LED_4_SIO_DIFF           (* (reg8 *) LED_4__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define LED_4_0_INTTYPE_REG 		(* (reg8 *) LED_4__0__INTTYPE)
#endif /* (LED_4__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_LED_4_H */
