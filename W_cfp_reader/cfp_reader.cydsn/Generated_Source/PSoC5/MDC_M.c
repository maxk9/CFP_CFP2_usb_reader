...
*
* \funcusage
*  \snippet MDC_M_SUT.c usage_MDC_M_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet MDC_M_SUT.c usage_MDC_M_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet MDC_M_SUT.c usage_MDC_M_Read  
*******************************************************************************/
...
* preferred MDC_M_Read() API because the 
* MDC_M_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet MDC_M_SUT.c usage_MDC_M_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: MDC_M_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use MDC_M_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - MDC_M_0_INTR       (First pin in the list)
    *  - MDC_M_1_INTR       (Second pin in the list)
    *  - ...
    *  - MDC_M_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet MDC_M_SUT.c usage_MDC_M_SetInterruptMode
    *******************************************************************************/
    void MDC_M_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & MDC_M_0_INTR) != 0u) 
		{ 
			 MDC_M_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet MDC_M_SUT.c usage_MDC_M_ClearInterrupt
    *******************************************************************************/
