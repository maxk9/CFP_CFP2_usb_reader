...
extern const uint8 CYCODE USBUART_1_STRING_DESCRIPTORS[141u];
...
const uint8 CYCODE *USBUART_1_GetInterfaceClassTablePtr(void)                    ;uint8 USBUART_1_ClearEndpointHalt(void)                                          ;
