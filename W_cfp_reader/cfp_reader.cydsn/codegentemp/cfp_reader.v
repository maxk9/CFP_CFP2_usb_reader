...
`ifdef WARP
`define CY_BLK_DIR "D:\PROJECT\pgm\Adaptor_CFP_CFP2_Cypress\cfp_reader\W_cfp_reader\cfp_reader.cydsn\MDIO_host_my_v"
`include "D:\PROJECT\pgm\Adaptor_CFP_CFP2_Cypress\cfp_reader\W_cfp_reader\cfp_reader.cydsn\MDIO_host_my_v\MDIO_host_my_v.v"
`else
`define CY_BLK_DIR "D:\PROJECT\pgm\Adaptor_CFP_CFP2_Cypress\cfp_reader\W_cfp_reader\cfp_reader.cydsn\MDIO_host_my_v"
`include "D:\PROJECT\pgm\Adaptor_CFP_CFP2_Cypress\cfp_reader\W_cfp_reader\cfp_reader.cydsn\MDIO_host_my_v\MDIO_host_my_v.v"
`endif
...
module top ;
    ...
    USBFS_v3_10_2 USBUART_1 (
        .sof(Net_1243),
        .vbusdet(1'b0));
    defparam USBUART_1.epDMAautoOptimization = 0;

	wire [0:0] tmpOE__MOD_ABS_net;
	wire [0:0] tmpIO_0__MOD_ABS_net;
	wire [0:0] tmpINTERRUPT_0__MOD_ABS_net;
	electrical [0:0] tmpSIOVREF__MOD_ABS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("320bbb84-5cfc-49e6-8e39-4018690676cb"),
		  ...
		  .input_buffer_sel(2'b00))
		MOD_ABS
		 (.oe(tmpOE__MOD_ABS_net),
		  .y({1'b0}),
		  .fb({Net_2211}),
		  .io({tmpIO_0__MOD_ABS_net[0:0]}),
		  .siovref(tmpSIOVREF__MOD_ABS_net),
		  .interrupt({tmpINTERRUPT_0__MOD_ABS_net[0:0]}),
		  .annotation({Net_2187}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MOD_ABS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_789 = Net_2197 ^ Net_2196;
	...
	wire [0:0] tmpOE__MOD_RST_net;
	wire [0:0] tmpFB_0__MOD_RST_net;
	wire [0:0] tmpIO_0__MOD_RST_net;
	wire [0:0] tmpINTERRUPT_0__MOD_RST_net;
	electrical [0:0] tmpSIOVREF__MOD_RST_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f32f12dd-654f-490e-9904-ec41673c6a42"),
		  ...
		  .input_buffer_sel(2'b00))
		MOD_RST
		 (.oe(tmpOE__MOD_RST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MOD_RST_net[0:0]}),
		  .io({tmpIO_0__MOD_RST_net[0:0]}),
		  .siovref(tmpSIOVREF__MOD_RST_net),
		  .interrupt({tmpINTERRUPT_0__MOD_RST_net[0:0]}),
		  .annotation({Net_2188}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MOD_RST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_4_data_net;
	wire [0:0] tmpFB_0__LED_4_data_net;
	wire [0:0] tmpIO_0__LED_4_data_net;
	wire [0:0] tmpINTERRUPT_0__LED_4_data_net;
	electrical [0:0] tmpSIOVREF__LED_4_data_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("db22e86d-277d-4d65-b1bd-1104894db3b0"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_4_data
		 (.oe(tmpOE__LED_4_data_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_4_data_net[0:0]}),
		  .io({tmpIO_0__LED_4_data_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_4_data_net),
		  .interrupt({tmpINTERRUPT_0__LED_4_data_net[0:0]}),
		  .annotation({Net_2136}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_4_data_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MOD_GALM_net;
	wire [0:0] tmpFB_0__MOD_GALM_net;
	wire [0:0] tmpIO_0__MOD_GALM_net;
	wire [0:0] tmpINTERRUPT_0__MOD_GALM_net;
	electrical [0:0] tmpSIOVREF__MOD_GALM_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8695c641-4d29-429d-a85d-b2c137f8bb81"),
		  ...
		  .input_buffer_sel(2'b00))
		MOD_GALM
		 (.oe(tmpOE__MOD_GALM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MOD_GALM_net[0:0]}),
		  .io({tmpIO_0__MOD_GALM_net[0:0]}),
		  .siovref(tmpSIOVREF__MOD_GALM_net),
		  .interrupt({tmpINTERRUPT_0__MOD_GALM_net[0:0]}),
		  .annotation({Net_2192}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MOD_GALM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MOD_RX_LOS_net;
	wire [0:0] tmpFB_0__MOD_RX_LOS_net;
	wire [0:0] tmpIO_0__MOD_RX_LOS_net;
	wire [0:0] tmpINTERRUPT_0__MOD_RX_LOS_net;
	electrical [0:0] tmpSIOVREF__MOD_RX_LOS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8ce0c6b6-83f3-43ad-b285-cd3e4b2c5927"),
		  ...
		  .input_buffer_sel(2'b00))
		MOD_RX_LOS
		 (.oe(tmpOE__MOD_RX_LOS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MOD_RX_LOS_net[0:0]}),
		  .io({tmpIO_0__MOD_RX_LOS_net[0:0]}),
		  .siovref(tmpSIOVREF__MOD_RX_LOS_net),
		  .interrupt({tmpINTERRUPT_0__MOD_RX_LOS_net[0:0]}),
		  .annotation({Net_2191}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MOD_RX_LOS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [2:0] tmpOE__I_PRG_CNTL_net;
	wire [2:0] tmpFB_2__I_PRG_CNTL_net;
	wire [2:0] tmpIO_2__I_PRG_CNTL_net;
	wire [0:0] tmpINTERRUPT_0__I_PRG_CNTL_net;
	electrical [0:0] tmpSIOVREF__I_PRG_CNTL_net;
	...
	cy_psoc3_pins_v1_10
		...
		I_PRG_CNTL
		 (.oe(tmpOE__I_PRG_CNTL_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__I_PRG_CNTL_net[2:0]}),
		  .io({tmpIO_2__I_PRG_CNTL_net[2:0]}),
		  .siovref(tmpSIOVREF__I_PRG_CNTL_net),
		  .interrupt({tmpINTERRUPT_0__I_PRG_CNTL_net[0:0]}),
	...
	assign tmpOE__I_PRG_CNTL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};
	...
	wire [2:0] tmpOE__O_ALM_net;
	wire [2:0] tmpIO_2__O_ALM_net;
	wire [0:0] tmpINTERRUPT_0__O_ALM_net;
	electrical [0:0] tmpSIOVREF__O_ALM_net;
	...
	cy_psoc3_pins_v1_10
		...
		O_ALM
		 (.oe(tmpOE__O_ALM_net),
		  ...
		  .io({tmpIO_2__O_ALM_net[2:0]}),
		  .siovref(tmpSIOVREF__O_ALM_net),
		  .interrupt({tmpINTERRUPT_0__O_ALM_net[0:0]}),
	...
	assign tmpOE__O_ALM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};
